-- 1. Lifecycle State Management RPCs
...
begin
  ...
  select donor_id, status into v_listing_owner_id, v_listing_status
  ...
  values (
    ...
    'pickup_request',
    'New Pickup Request',
    'Someone requested to pickup your listing.',
    '/activity'
  );
...
begin
  ...
  values (
    ...
    'pickup_accepted',
    'Request Accepted',
    'Your pickup request was accepted! Go to Activity to view details.',
    '/activity'
  );
...
-- D. Complete Delivery (Volunteer action - Dropoff)
